export const SITE = {
  ...
  tagline: 'Honest, tested reviews of walking pads and recovery gear.',
  description:
    'Independent, hands-on reviews and buying guides for walking pads, treadmills, massage guns, and recovery equipment — so you can move and recover better.',
  contactEmail: 'movewellreviews@gmail.com',
  twitter: '',
  founded: 2026,
};
